...
<head>
    ...
    <title>Mail Send To {{ $guest->FirstName }}</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <div class="container mt-5">
        <h1 class="mb-4 text-center">Mail Send To {{ $guest->FirstName }}</h1>
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="shadow card">
                    <div class="card-body">
                        <form name="sentMessage" novalidate="novalidate" method="POST" action="{{route('mailing',$guest->id)}}">
                            @csrf
                            <div class="mb-3">
